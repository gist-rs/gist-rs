  ...
  return (
    <div>
      ...
      <div style={{ width: 'fit-content' }}>
        <div id="g_id_onload" data-ux_mode="redirect" data-client_id={import.meta.env.GOOGLE_CLIENT_ID} data-callback={import.meta.env.GOOGLE_REDIRECT_URL} data-auto_prompt="false"></div>
