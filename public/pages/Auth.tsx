...
const Auth = () => {
  ...
  return (
    <div>
      ...
      <pre>
        <code>import.meta.env:{JSON.stringify(import.meta.env, null, 2)}</code>
      </pre>
      <pre>
        <code>process.env:{JSON.stringify(process.env, null, 2)}</code>
      </pre>
      ...
      <div style={{ width: 'fit-content' }}>
        <div
          ...
          data-callback={import.meta.env.GOOGLE_REDIRECT_URL || process.env.WMR_GOOGLE_REDIRECT_URL}
